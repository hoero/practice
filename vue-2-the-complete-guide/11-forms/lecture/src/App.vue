        ...
        <form>
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 form-group">
                    ...
                    <textarea id="message" rows="5" class="form-control" v-model="msg"></textarea>
                </div>
            </div>
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3">
            ...
            <div class="row">
                <div class="col-xs-12 col-sm-8 col-sm-offset-2 col-md-6 col-md-offset-3 from-group">
                    ...
                    <select id="priority" class="form-control" v-model="selectedPriority">
                        <!--:selected only works without v-model because it gets overwritten by it i.e. :selected="priority === 'Medium'" -->
...
export default {
    data() {
        return {
            ...
            msg:
                'Qui laboriosam aliquam error quia qui ullam at distinctio non.',
            sendMail: [],
            gender: 'Male',
